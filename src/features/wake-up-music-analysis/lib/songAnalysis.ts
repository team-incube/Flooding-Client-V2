...
const AUTO_CAPTION_MARKER =
  /\[(music|음악|박수|applause|laughter|웃음|박수 소리)\]|[♪♫]/i;

export function isAutoGeneratedCaption(transcript: string): boolean {
  return AUTO_CAPTION_MARKER.test(transcript);
}
