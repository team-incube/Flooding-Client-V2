export function SecondFloor() {
  return (
    <div className="w-[1116px] h-[544px] bg-white rounded-2xl border border-sub-2 overflow-hidden">
      ...
      <div className="grid grid-cols-[1fr_80px_1fr] h-[209px]">
        <button className="flex flex-col items-center justify-center gap-1 border-r border-sub-2 cursor-pointer">
      ...
      <div className="pt-[26px] pb-[25px] text-center border-t border-sub-2">
        <span className="text-sub-2 text-[16.82px] font-medium">2F 복도</span>
      </div>
    </div>
  );
}
