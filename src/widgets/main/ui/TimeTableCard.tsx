...
export default function TimeTableCard() {
  ...
  return (
    <div className="w-full min-w-[280px] h-[334px] bg-background-surface rounded-2xl p-4">
      ...
      <div className="flex flex-col gap-3 h-[262px] overflow-auto">
        {items.map((it, idx) => {
          ...
          return (
            <div
              key={it.period}
              className={`flex items-center justify-between px-3 p-3 rounded-lg bg-sub-4 ${
                active && "border border-p-1"
              }`}
            >
              <div className="flex items-center gap-1">
                <span className="font-medium text-sub-1 text-text-4">
                  {it.period}
                </span>
              ...
              <div className="flex items-center gap-1 text-sub-1 text-caption-1 font-medium">
                <span>{it.subject}</span>
                <span className="text-caption-2 text-sub-2 font-medium">
                  {it.teachers}
                </span>
              </div>
            </div>
